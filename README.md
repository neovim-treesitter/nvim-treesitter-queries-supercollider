# nvim-treesitter-queries-supercollider

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-supercollider/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-supercollider/actions/workflows/validate.yml)

Neovim tree-sitter queries for **supercollider**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-supercollider",
...
- [ ] Changes are scoped to `supercollider` — do not include files for other languages
